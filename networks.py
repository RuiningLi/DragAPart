...
def get_down_block(
    ...
    **kwargs,
    ...
    """
    An wrapper for diffusers' default get_down_block
    """
...
def get_up_block(
    ...
    **kwargs,
    ...
    """
    An wrapper for diffusers' default get_up_block
    """
...
class UNet2DDragConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def __init__(
        ...
        for i, down_block_type in enumerate(down_block_types):
            ...
            down_block = get_down_block(
                ...
                flow_channels=self.drag_extra_dim,
            )
    ...
    def forward_with_cfg(
        ...
        model_out = self.forward(combined, t, x_cond, force_drop_ids=force_drop_ids, hidden_cls=hidden_cls, drags=drags)
